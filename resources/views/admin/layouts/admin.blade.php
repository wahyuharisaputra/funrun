...
<body class="flex h-screen overflow-hidden text-slate-800">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 flex flex-col transition-all">
        <div class="h-20 flex items-center px-6 border-b border-slate-200">
            <img src="{{ asset('images/setiket.webp') }}" alt="SeTiket Logo" class="h-8 w-auto object-contain mr-3">
        ...
        <nav class="flex-1 py-6 flex flex-col gap-2">
            ...
            <a href="{{ route('admin.admins') }}" class="sidebar-item px-6 py-3 flex items-center gap-3 text-slate-600 hover:bg-slate-50 transition-colors {{ request()->routeIs('admin.admins') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                Manajemen Admin
            </a>
            @endif
        ...
        <header class="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 z-10">
            ...
            <div class="flex items-center gap-4">
                <div class="flex flex-col items-end">
                    ...
                    <span class="text-xs text-slate-500 capitalize">{{ str_replace('_', ' ', auth()->user()->role) }}</span>
                </div>
                <div class="w-10 h-10 rounded-full bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center font-bold">
