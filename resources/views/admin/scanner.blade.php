    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 text-center">
        ...
        <div class="mt-8 text-left">
            ...
            <div class="flex gap-2">
                <input type="text" id="manual-qr" placeholder="Enter Ticket Code (e.g. FR2026-00001)..." class="flex-1 border border-slate-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 uppercase">
