                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        @elseif($payment->payment_status === 'paid')
                            <div class="flex flex-col gap-2 justify-center items-center">
                                <button disabled class="bg-slate-200 text-slate-500 px-4 py-2 rounded-lg text-xs font-medium cursor-not-allowed w-full">
                                    Approved
                                </button>
                                @php
                                ...
                                @endphp
                                <a href="https://wa.me/{{ $waNumber }}?text={{ $waText }}" target="_blank" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-xs font-medium transition-colors w-full flex items-center justify-center gap-1">
